//
//  PersonDetailsSubtitleCell.swift
//  OfficeeApp
//
...
final class PersonDetailsSubtitleCellModel: BaseTableCellModel {
...
final class PersonDetailsSubtitleCell: BaseTableCell {
  ...
  override func configure(with model: BaseTableCellModel) {
    guard let model = model as? PersonDetailsSubtitleCellModel else {
